...
class AdaptiveQuantumPipelineFixed:
    ...
    def _initialize_components(self):
        ...
        try:
            ...
            if phase2_path.exists():
                ...
                print(f"    ⚠️  GNN model not found at {phase2_path}, using fallback")
            ...
            if phase3_path.exists():
                ...
                print(f"    ⚠️  RL Compiler not found at {phase3_path}, using fallback")
            ...
            if phase4_path.exists():
                ...
                print(f"    ⚠️  VAE model not found at {phase4_path}, using fallback")
    ...
    def run_pipeline(self, circuit_name, qubit_count=20):
        ...
        try:
            ...
            results['metrics']['original_gates'] = circuit_info.get('gates', 100)
            results['metrics']['optimized_gates'] = compiled_circuit.get('optimized_gates', 0)
            reduction = 100 * (1 - results['metrics']['optimized_gates'] / results['metrics']['original_gates'])
    ...
    def _load_noise_profile_fixed(self, qubit_count):
        ...
        print(f"    ⚠️  No noise profile found for {qubit_count}q, generating synthetic...")
    ...
    def _generate_synthetic_errors_fixed(self, noise_profile):
        ...
        if self.vae_model:
            try:
                ...
                print(f"    ⚠️  VAE generation failed: {e}")
